...
#define WEATHER_FORECAST_URL_TODAY "http://api.weatherapi.com/v1/forecast.json?key=db03e9230fea4859a9c74636233110&q=-37.9157,145.0160&days=1&aqi=no&alerts=no"
#define WEATHER_FORECAST_URL_TOMORROW "http://api.weatherapi.com/v1/forecast.json?key=db03e9230fea4859a9c74636233110&q=-37.9157,145.0160&days=2&aqi=no&alerts=no"
...
public:
    ...
    float GetRainForecast(bool tomorrow);
